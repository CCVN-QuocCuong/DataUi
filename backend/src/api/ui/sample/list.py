...
def handler(event, context):
    """
    Definition:
        - Function to get list Sample object haven't generated (ttcl_pointsampletest.cocprepared = false)
    ...
    try:
        ...
        query_get_sample_list = "select c1.sampleid, c3.staff as createdby, c3.collectiondate, c4.objective, c4.jobnumber, c4.siteid, c4.siteaddress, c3.pointname, fromdepth, todepth, sampletype, samplematerialtype, c5.containertype, barcode, testidlist, teststringlist, c1.created \
            ...
            where c1.pointid = c3.pointid and c3.surveyid = c4.surveyid and c1.sampleid = c5.sampleid and c5.sampleid = c2.arcgissampleid and c5.labcode = c2.barcode and c2.cocprepared = false order by c1.created desc,  c3.collectiondate desc "
        results = fetch_data(conn, query_get_sample_list)
        conn.close()
        
        sample_list = json.loads(results)
