...
export function TestTypeForm({ selectedSample, sampleType, open, closeModal }) {
    ...
    /**
     * Handle parse test types 
     * @param {Array} arrTestTypes
     * @param {Array} selectedTestType
     * @returns {Array}
     */
    ...
    /**
     * Render UI tree checkbox
     * @dependency {listTestTypes, testTypeChecked, handleTreeReady, handleChecked, handleSelected}
     */
